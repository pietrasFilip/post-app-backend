...
class FindByIdTest {
    ...
    @Test
    @DisplayName("When client with given id is found")
    void test1() {
        ...
        assertThat(clientRepositoryDb.findById(clientToFind.getId()))
                .isEqualTo(Optional.of(client2));
    }

    @Test
    @DisplayName("When client with given id is not found")
    void test2() {
        assertThat(clientRepositoryDb.findById(1L))
                .isNotPresent();
    }
}
