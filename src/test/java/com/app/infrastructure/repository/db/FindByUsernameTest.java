...
class FindByUsernameTest {
    ...
    @Test
    @DisplayName("When client with given username is found")
    void test1() {
        ...
        var clientToFind = testEntityManager.persist(client2);
        testEntityManager.flush();

        assertThat(clientRepositoryDb.findByUsername(clientToFind.getUsername()))
                .isEqualTo(Optional.of(client2));
    }

    @Test
    @DisplayName("When client with given username is not found")
    void test2() {
        assertThat(clientRepositoryDb.findByUsername("AA"))
                .isNotPresent();
    }
}
