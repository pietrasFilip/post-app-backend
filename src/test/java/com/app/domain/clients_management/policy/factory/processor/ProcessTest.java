...
class ProcessTest {
    ...
    @Autowired
    private ClientDataProcessor clientDataProcessorDb;

    @Test
    @DisplayName("When there is data in db")
    void test1() {
        ...
        var clients = List.of(client1.toDomain(), client2.toDomain());

        assertThat(clientDataProcessorDb.process())
                .isEqualTo(clients);
    }

    @Test
    @DisplayName("When there is no data in db")
    void test2() {
        assertThat(clientDataProcessorDb.process())
                .isEqualTo(List.of());
    }
